...
| iPhone向けWeb    | Compact Web                | iPhoneのブラウザで利用するSubBuddy Web。PC版と同じ機能・データを扱い、「ホーム・契約・見直し」の下部ナビを使う。ブラウザや端末モデルごとの別製品には分けない。                                                                 |
| PC向けWeb        | Desktop Web                | 幅の広いブラウザで利用するSubBuddy Web。主要移動には左サイドバーを使う。                                                                                                                                                       |
